...
import com.idev4.reports.config.ApplicationProperties;
 ...
 * to retry Schedule when cron job throw exception
 */
@EnableRetry
public class ReportserviceApp {
    ...
    public ReportserviceApp(Environment env) {
        this.env = env;
    }
